    ...
    public void bottomNavigationViewPosition(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.circular:
                ...
                getMvpView().moveToEventsActivity();
            ...
            case R.id.more:
                ...
                getMvpView().moveToFeeDetailsActivity();

                break;
            case R.id.heartrate:
//
                getMvpView().moveToHeartRateActivity();
//
                break;
            case R.id.whereismystudent:
//
                getMvpView().moveToWhereIsActivity();
//
                break;
